...
<head>
    ...
    <!-- Page Title -->
    <title>School Bills Management - Home</title>
    <meta content="School Bills Management system to manage every incoming ang outgoing money in a school" name="description">
...
<body>
                ...
                <div class="row">
                    <div class="col-lg-3 mb-5 mb-lg-0">
                        <div class="d-flex">
                            ...
                            <div class="info-text">
                                <h4>Ofemco Intl. Services Limited</h4>
                        ...
                        <div class="d-flex">
                            ...
                            <div class="info-text">
                                <h4 style="text-transform: lowercase">ofemco@gmail.com</h4>
    ...
    <footer style="height: 70px !important; line-height: 70px; margin-top: -100px" class="text-center footer-area">
        <div class="footer-copyright">
            <div class="container">
                 Copyright &copy; Ofemco <script>document.write(new Date().getFullYear());</script> All rights reserved | Developed by Devugo
            </div>
        </div>
    </footer>
        <!-- Footer Area End -->
