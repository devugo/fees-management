            ...
            <nav class="navbar top-navbar navbar-expand-md navbar-light">
                ...
                <div class="navbar-collapse">
                    ...
                    <ul class="navbar-nav my-lg-0">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu mailbox dropdown-menu-right scale-up" aria-labelledby="2">
                                <ul>
                                    ...
                                    <li>
                                        <?php
                                            $admin_notifications = Ticket::all()->sortByDesc('id');
                                        ...
                                        <?php
                                            ...
                                            foreach($admin_notifications as $notification){
                                                ...
                                                ?>
                                                <a href="<?=$this->domain()?>/admin/view-ticket/<?=$notification->id?>">
                                                    <div class="user-img"> <img src="<?=$this->domain()?>/<?=$notification->school->name?>" alt="user" class="img-circle"> <span class="profile-status online pull-right"></span> </div>
                                    ...
                                    <li>
                                        <a class="nav-link text-center" href="<?=$this->domain()?>/admin/ticket"> <strong>See all Notifications</strong> <i class="fa fa-angle-right"></i> </a>
                                    </li>
                                </ul>
                            </div>
                        </li>
                        ...
                        <!-- ============================================================== -->
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle text-muted waves-effect waves-dark" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img src="<?=$this->domain()?>/<?=$this->admin()->logo?>" alt="user" class="profile-pic" /></a>
                            <div class="dropdown-menu dropdown-menu-right scale-up">
                                <ul class="dropdown-user">
                                    <li>
                                        <div class="dw-user-box">
                                            <div class="u-img"><img src="<?=$this->domain()?>/<?=$this->admin()->logo?>" alt="user"></div>
                                            <div class="u-text">
                                                <h4><?=$this->admin()->name?></h4>
                                                <p class="text-muted"><?=$this->admin()->email?></p><a href="<?=$this->domain()?>/profile" class="btn btn-rounded btn-danger btn-sm">View Profile</a></div>
                                        </div>
                                    </li>
                                    <li role="separator" class="divider"></li>
                                    <li><a href="<?=$this->domain()?>/admin/profile"><i class="ti-user"></i> My Profile</a></li>
                                    <li><a href="<?=$this->domain()?>/admin/notification"><i class="ti-email"></i> Inbox</a></li>
                                    <li role="separator" class="divider"></li>
                                    <li><a href="<?=$this->domain()?>/admin/logout"><i class="fa fa-power-off"></i> Logout</a></li>
                                </ul>
                            </div>
                        </li>
                        <!-- ============================================================== -->
