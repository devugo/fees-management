...
<head>
    ...
    <title><?=Config::get('default/project_title')?> | Super Admin Login</title>
    <!-- Bootstrap Core CSS -->
    ...
    <section id="wrapper">
        <div class="login-register" style="background-color: grey; background-image:url();">
            ...
            <div class="login-box card">
                <div class="card-body">
                    <form class="form-horizontal form-material" id="loginform" method="post" action="<?=Config::get('default/domain')?>/admin-manager/authenticate">
