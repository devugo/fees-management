...
<head>
    ...
    <title><?=Config::get('default/project_title')?> | Guardian Login</title>
    <!-- Bootstrap Core CSS -->
    ...
    <section id="wrapper">
        <div class="login-register" style="background-color: grey; background-image:url();">
            ...
            <div class="login-box card">
                <div class="card-body">
                    <form class="form-horizontal form-material" id="loginform" method="post" action="<?=Config::get('default/domain')?>/guardian-manager/authenticate">
                        <h3 class="box-title m-b-20">Guardian Sign In</h3>
                        ...
                        <div class="form-group m-b-0">
                            <div class="col-sm-12 text-center">
                                Are you a school admin? <a href="<?=$this->domain()?>/login" class="text-info m-l-5"><b>Login Here</b></a>
                            </div>
                        </div>
                    </form>
                </div>
