            ...
            <div class="container-fluid">
                ...
                <?php
                   ...
                   /* $phone = $this->school()->phone;
                    $sms = new SMS;
                    $sms->send_sms($phone, 'Testing sms api');*/
                    ...
                    <div class="col-lg-8">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="table-responsive m-t-20">
                                <?php
                                    $students = $this->school()->users->sortByDesc('id');
                                ?>
                                    <table class="table stylish-table">
                                        <thead>
                                            <tr>
                                        ...
                                        <?php
                                            ...
                                            foreach($students as $student){
                                                ...
                                                echo '<tr>';
                                                    echo '<td><span class="round"><img src="' . $this->domain() . '/' . $student->profile_pix . '" alt="user" width="50"></span></td>';
                                                    echo '<td><h6>' . $student->lastname . ' ' . $student->firstname . ' ' . $student->middlename . '</h6><small data-toggle="tooltip" data-placement="top" title="" data-original-title="Guardian" class="text-muted">' . $student->guardian->lastname . ' ' . $student->guardian->firstname . '</small></td>';
                                                    echo '<td>' . $classes[classe($student->year_of_graduation, $years)] . $student->arm->name . '</td>';
                                                    echo '<td><span class="label label-primary">' . $student->created_at->toFormattedDateString() . '</span></td>';
                                                echo '</tr>';
                                                $count++;
                                            }
                                        ?>
                    ...
                    <div class="col-lg-4">
                        ...
                        <div class="card">
                            <div class="card-body little-profile">
                                <div class="pro-img text-center"><img src="<?=$this->domain()?>/<?=$this->school()->logo?>" alt="user"></div>
                                <h3 class="m-b-0 text-center"><?=$this->school()->name?></h3><hr>
                                <p><strong>Email:</strong> <?=$this->school()->email?></p><hr>
                                <p><strong>Phone:</strong> <?=$this->school()->phone?></p><hr>
                                <p><strong>Address:</strong> <?=$this->school()->address?></p><hr>
                                <p><strong>City:</strong> <?=$this->school()->city?></p><hr>
                                <p><strong>State:</strong> <?=$this->school()->state?></p><hr>
                            </div>
                        </div>
                        <!-- Column -->
                    </div>
