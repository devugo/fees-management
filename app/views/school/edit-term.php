                    ...
                    <div class="col-lg-5">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <?php
                                    $term = $this->school()->terms->find($data['id']);
                                ?>
                                <form class="form-horizontal p-t-20" action="/school-manager/update-term/<?=$data['id']?>" method="post">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <div class="input-group">
                                                ...
                                                <input type="text" min="2000" value="<?=School::get_session()?>" name="session" class="form-control" placeholder="Sesssion" disabled>
                                    ...
                                    ?>
                                        ...
                                        <div class="col-sm-10">
                                            <div class="input-group">
                                                ...
                                                <select class="form-control" name="term" disabled>
                                                    <option value="First Term" <?=selected($term->term, 'First Term')?>>1st</option>
                                                    <option value="Second Term" <?=selected($term->term, 'Second Term')?>>2nd</option>
                                                    <option value="Third Term" <?=selected($term->term, 'Third Term')?>>3rd</option>
                                                </select>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <div class="input-group">
                                                ...
                                                <input type="date" name="start" value="<?=$term->start?>" class="form-control">
