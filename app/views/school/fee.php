                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <small class="label label-primary">Fee should be prepared immediately after adding.</small>
                                <form class="form-horizontal p-t-20" action="/school-manager/create-fee" method="post">
                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive m-t-40">
                                    <table id="myTable" class="table table-bordered table-striped">
                                        ...
                                        {
                                            if($val->noti_sent != NULL){
                                                return '<span class="label label-success">Messages Sent</span>';
                                            }else if($val->prepared_fees->sum('amount') > 0){
                                                return '<span class="label label-primary">Prepared</span>';
                                            }else{
                                            ...
                                            foreach($fees as $fee){
                                                ...
                                                echo '<td class="text-center">' . prepared($fee) . '</td>';
                                                echo '<td class="text-center"><i onclick="sendNotification(' . $fee->id . ')" style="color: orange; cursor: pointer;"  data-toggle="tooltip" data-placement="top" title="" data-original-title="Send Notification" class="fa fa-envelope"></i>'; ?> <?=(!$fee->send_noti()) ? '<a href="' . $this->domain() . '/school/prepare-fee/' . $fee->id . '"><i style="color: green;" data-toggle="tooltip" data-placement="top" title="" data-original-title="Prepare Fee" class="fas fa-dna"></i></a>' : ''?> <?php echo '<a href="' . $this->domain() . '/school/edit-fee/' . $fee->id . '"><i data-toggle="tooltip" data-placement="top" title="" data-original-title="Edit Fee" style="color: dodgerblue" class="fa fa-edit"></i></a> <i data-toggle="tooltip" data-placement="top" title="" data-original-title="Delete Fee" class="fa fa-trash" style="color: brown; cursor: pointer;" onclick="deleteFee(' . $fee->id . ')"></td>';
                                                echo '</tr>';
                                                $sn++;
                                            }
                                        ?>
