            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-5">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Edit Arm</h4>
                                <?php 
                                    $arm = $this->school()->arms->find($data['id']);
                                ?> 
                                <form class="form-horizontal p-t-20" action="/school-manager/update-arm/<?=$data['id']?>" method="post">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" name="arm" value="<?=$arm->name?>" id="arm" placeholder="Enter Arm">
